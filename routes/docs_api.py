...
_ALLOWED_DOCS = {
    ...
    "platform-entity-model": "design/PLATFORM_ENTITY_MODEL.md",
    "prompt-artifact-contract": "design/PROMPT_ARTIFACT_CONTRACT.md",
    "ocac-stability-bridge": "design/OCAC_STABILITY_BRIDGE.md",
    "tcst-agent-model":  "design/TCST_AGENT_MODEL.md",
    "history":           "records/HISTORY.md",
    "findings":          "records/FINDINGS.md",
    "failures":          "records/FAILURES.md",
    "issues":            "records/ISSUES.md",
    "open-problems":     "records/OPEN_PROBLEMS.md",
    "scorecard":         "records/SCORECARD.md",
    "strategic-scorecard": "records/STRATEGIC_SCORECARD.md",
    "metrics-roadmap":   "records/METRICS_ROADMAP.md",
    "improvements":      "records/IMPROVEMENTS.md",
    "vision":            "product/VISION.md",
    "comparison":        "product/COMPARISON.md",
    "positioning":       "product/POSITIONING.md",
    "launch-debugger":   "product/LAUNCH_DEBUGGER.md",
    "deploy":            "ops/DEPLOY.md",
    "providers":         "ops/PROVIDERS.md",
    "disaster-recovery": "ops/DISASTER_RECOVERY.md",
    "releasing":         "ops/RELEASING.md",
    "troubleshooting-windows": "ops/TROUBLESHOOTING_WINDOWS.md",
}
