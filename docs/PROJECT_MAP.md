...
**Updated:** 2026-06-22 · **Version:** v1.4.4
...
| **v1.4.1–1.4.4** | **UI & brand refinement** (lux-card sweep, gold titles, AMAGRA wordmark favicon) | ✅ Shipped |
| v1.5 → v2.0 | Providers · workspaces · team memory · agent registry | ⬜ Planned |
