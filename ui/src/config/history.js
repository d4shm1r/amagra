// history.js — the hand-maintained release record: what shipped, what's next,
// and how the phases group into versions.
//
// This file is LAZY ON PURPOSE. It is ~1,200 lines of prose and it must never
// reach the eager first-paint chunk, so only lazy tabs may import it
// (VersionHistoryTab, AboutTab). If an eager tab needs a fact from here, derive
// it into a small constant in constants.js instead of importing the arrays —
// config/history.sync.test.js keeps those derived constants honest.
...
export const BUILD_PHASES = [
  ...
  },
  {
    ...
    steps: [
      ...
      "PlanGraphPanel.jsx — pure SVG DAG, parallel level columns, node status/uncertainty/elapsed_ms, click-to-detail panel",
  ...
  },
  {
    ...
    steps: [
      ...
      "Rounded badges/pills + shared PageHeader/RefreshButton from ObsShared across observability views",
      "Fix: CognitiveMapPanel `T as C` alias left card/blue/green colors undefined — explicit local palette",
