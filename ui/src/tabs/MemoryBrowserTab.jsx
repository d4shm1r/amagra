...
import { T, LUX, GOLD, FONT_MONO } from "@/styles/theme";
import { RefreshButton, EmptyState, PageHeader, MetricCard } from "@/components/ui";
import CognitiveMapPanel from "@/components/panels/CognitiveMapPanel";
import { MemoryAdminPanel } from "@/components/panels/SystemPanels";
...
export default function MemoryBrowserTab() {
  ...
  return (
    <div style={{ color: T.text, fontFamily: "inherit" }}>
      ...
      {view === "graph" ? <CognitiveMapPanel embedded /> : (<>
